...
@endif
 <div class='row'>
            <form action="{{ route('sale_return_items.updating',['id' => $sale_return_items->id]) }}" method="POST"  enctype="multipart/form-data">
        @csrf
 <div class='row'>
        <div class='col-xs-12 col-sm-12 col-md-12'>
            <div class='form-group'>
                <strong>Quantity:</strong>
                <input type='text' name='form_quantity' value='{{ $sale_return_items->quantity }}' class='form-control' placeholder='form_quantity'>
            </div>
        </div>
...
                <input type='text' name='form_unit_price' value='{{ $sale_return_items->unit_price }}' class='form-control' placeholder='form_unit_price'>
            </div>
        </div>
...
                <input type='text' name='form_subtotal' value='{{ $sale_return_items->subtotal }}' class='form-control' placeholder='form_subtotal'>
            </div>
        </div>
