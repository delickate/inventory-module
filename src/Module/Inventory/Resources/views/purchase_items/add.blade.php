...
<input type='text' name='form_quantity' value='{{ old('form_quantity') }}'  placeholder='form_quantity'>
</div>
</div>
</div>
...
<input type='text' name='form_unit_price' value='{{ old('form_unit_price') }}'  placeholder='form_unit_price'>
</div>
</div>
</div>			
