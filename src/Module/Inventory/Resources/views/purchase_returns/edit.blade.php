...
@endif
 <div class='row'>
            <form action="{{ route('purchase_returns.updating',['id' => $purchase_returns->id]) }}" method="POST"  enctype="multipart/form-data">
@csrf
...
<input type='text' name='form_return_date' value='{{ $purchase_returns->return_date }}' class='form-control' placeholder='form_return_date'>
</div>
</div>
...
<input type='text' name='form_total_amount' value='{{ $purchase_returns->total_amount }}' class='form-control' placeholder='form_total_amount'>
</div>
</div>
...
<input type='text' name='form_reason' value='{{ $purchase_returns->reason }}' class='form-control' placeholder='form_reason'>
</div>
</div>
