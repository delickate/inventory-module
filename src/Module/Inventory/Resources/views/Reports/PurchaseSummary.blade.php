...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="row">
                <div class="col-md-8">
                    <form method="GET" action="{{ route('inventoryReports.PurchaseSummary') }}">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('inventoryReports.PurchaseSummary') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card text-white bg-success">
                        <div class="card-body">
                            ...
                            <p class="card-text h4">{{ number_format($summary_totals['purchase_count']) }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="card text-white bg-warning">
                        <div class="card-body">
                            ...
                            <p class="card-text h4">{{ number_format($summary_totals['avg_purchase_value'], 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered" id="purchaseTable">
                        ...
                        <tr>
                            ...
                            @switch($filters['group_by'])
                                @case('product')
                                    ...
                                    <td class="text-right">{{ number_format($item->avg_unit_price, 2) }}</td>
                    ...
                    <tfoot>
                        <tr class="font-weight-bold bg-light">
                            <td colspan="{{ in_array($filters['group_by'], ['product', 'supplier']) ? 3 : 2 }}" class="text-right">Totals:</td>
                            ...
                            <td class="text-right">{{ number_format($summary_totals['purchase_count']) }}</td>
                            @if($filters['group_by'] != 'product')
                                <td class="text-right">{{ number_format($summary_totals['total_quantity']) }}</td>
                            @endif
...
document.getElementById('exportBtn').addEventListener('click', function() {
    ...
    a.href = url;
    a.download = 'Purchase_Summary_' + new Date().toISOString().slice(0, 10) + '.xls';
